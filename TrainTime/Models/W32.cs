...
{
    ///copy from https://www.codeproject.com/Articles/856020/Draw-Behind-Desktop-Icons-in-Windows-plus
    ...
    public class W32
    {
        ...
        public static extern UInt32 GetWindowLong(IntPtr hWnd, Int32 index);

        [DllImport("user32.dll")]
        public static extern UInt32 SetWindowLong(IntPtr hWnd, Int32 index, UInt32 newLong);
